...
export const INITIAL_NETWORKS: Networks = {
    ...
    HEMI: {
        ...
        ens: false,
        showGasLevels: false,
        currentRpcUrl: 'https://rpc.hemi.network/rpc',
        defaultRpcUrl: 'https://rpc.hemi.network/rpc',
        iconUrls: [
            'https://raw.githubusercontent.com/block-wallet/assets/master/blockchains/hemi/info/logo.png',
        ],
        blockExplorerUrls: ['https://explorer.hemi.xyz/'],
        blockExplorerName: 'Hemi Explorer',
        actionsTimeIntervals: { ...ACTIONS_TIME_INTERVALS_DEFAULT_VALUES },
        tornadoIntervals: {
            depositConfirmations: DEFAULT_TORNADO_CONFIRMATION,
            derivationsForward: DERIVATIONS_FORWARD,
    ...
    REDDIO_TESTNET: {
        ...
        ens: false,
        showGasLevels: false,
        currentRpcUrl: 'https://reddio-dev.reddio.com',
        defaultRpcUrl: 'https://reddio-dev.reddio.com',
        iconUrls: [
            'https://raw.githubusercontent.com/block-wallet/assets/master/blockchains/reddiotestnet/info/logo.png',
        ],
        blockExplorerUrls: ['https://reddio-devnet.l2scan.co'],
        blockExplorerName: 'Reddio Explorer',
        actionsTimeIntervals: { ...ACTIONS_TIME_INTERVALS_DEFAULT_VALUES },
        tornadoIntervals: {
            depositConfirmations: DEFAULT_TORNADO_CONFIRMATION,
            derivationsForward: DERIVATIONS_FORWARD,
    ...
    HELIOS_TESTNET: {
        ...
        hasFixedGasCost: false,
        iconUrls: [
            'https://raw.githubusercontent.com/block-wallet/assets/master/blockchains/heliostestnet/info/logo.png',
        ],
        enable: true,
        test: true,
        order: 14,
        ...
        ens: false,
        showGasLevels: false,
        currentRpcUrl: 'https://testnet1.helioschainlabs.org',
        defaultRpcUrl: 'https://testnet1.helioschainlabs.org',
        blockExplorerUrls: ['https://explorer.helioschainlabs.org'],
        blockExplorerName: 'Helios Explorer',
        actionsTimeIntervals: { ...ACTIONS_TIME_INTERVALS_DEFAULT_VALUES },
        tornadoIntervals: {
            depositConfirmations: DEFAULT_TORNADO_CONFIRMATION,
            derivationsForward: DERIVATIONS_FORWARD,
