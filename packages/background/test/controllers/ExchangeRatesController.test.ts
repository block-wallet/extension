...
describe('Exchange Rates Controller AVX', function () {
    ...
    it('For ETH-USD it should feed the exchangeRates object', async function () {
    ...
    it('For ETH-ARS it should feed the exchangeRates object', async function () {
    ...
    it('For ETH-USD with TokenRates it should feed the exchangeRates object', async function () {
        sinon
            .stub(exchangeRatesController['_exchangeRateService'], 'getRate')
            .returns(Promise.resolve(50000));
    ...
    it('For AVX-USD it should feed the exchangeRates object', async function () {
        sinon
