        ...
        case RPCUrlValidation.CHAIN_ID_DOESNT_MATCH: {
            return withWrapper(
                <>
                    ...
                    <Tooltip
                        className={classnames(
                            "!-translate-x-3/4 !border !border-primary-grey-hover !w-40 !break-word !whitespace-normal",
                            toolTipClassName
                        )}
        ...
        case RPCUrlValidation.UNVERIFIED_ENDPOINT: {
            return withWrapper(
                <>
                    ...
                    <Tooltip
                        className={classnames(
                            "!-translate-x-full !border !border-primary-grey-hover !w-56 !break-word !whitespace-normal",
                            toolTipClassName
                        )}
        ...
        case ChainIdValidation.KNOWN_CHAIN_ID: {
            return withWrapper(
                <>
                    ...
                    <Tooltip
                        className={classnames(
                            "!-translate-x-3/5 !border !border-primary-grey-hover !w-40 !break-word !whitespace-normal",
                            toolTipClassName
                        )}
