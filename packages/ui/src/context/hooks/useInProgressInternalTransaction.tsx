...
import { useWaitingForSigningInternalTransaction } from "./useWaitingForSigningInternalTransaction"
...
export const useInProgressInternalTransaction = () => {
    ...
    return { transaction, clearTransaction: () => setCurrentTxId(undefined) }
}
