...
copyScript(
    paths.uiModules + "/webextension-polyfill/dist/browser-polyfill.min.js"
)

// base manifest. contains general properties.
const baseManifest = JSON.parse(
    fs.readFileSync(paths.manifests + "/base.json", "utf8")
)

// browser specific manifest.
const browserManifest = JSON.parse(
    fs.readFileSync(paths.manifests + `/${browser}.json`, "utf8")
)
